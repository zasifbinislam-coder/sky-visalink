...
import { ArrowRight, Plane, Star, Users, Globe, MapPin } from "lucide-react";
import { countries } from "@/lib/visa/data";
import type { Region } from "@/lib/visa/types";
import { businessInfo } from "@/lib/data";

// ── Pricing logic ──────────────────────────────────────────────────────
// Approximate per-person base price for a typical 4–5 day package.
// (BDT). These are illustrative starting estimates — the real quote is
// generated by the agency after confirming dates, hotel class & inclusions.
...
export default function QuickInquiry() {
  ...
  const estimate = useMemo(() => {
    const base = REGION_BASE[country.region];
    const mul = CLASS_MULTIPLIER[cls] ?? 1;
    return base * travellers * mul;
  }, [country, travellers, cls]);
